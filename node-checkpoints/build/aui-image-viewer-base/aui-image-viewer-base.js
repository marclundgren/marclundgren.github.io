...
var L = A.Lang,
    ...
    TPL_CONTROL_LEFT = '<a href="javascript:void(0)" class="' + concat(CSS_IMAGE_VIEWER_CONTROL, CSS_CAROUSEL_CONTROL, CSS_LEFT) +
        '">&lsaquo;</a>',
    TPL_CONTROL_RIGHT = '<a href="javascript:void(0)" class="' + concat(CSS_IMAGE_VIEWER_CONTROL, CSS_CAROUSEL_CONTROL, CSS_RIGHT) +
        '">&rsaquo;</a>',
