...
}, 'patched-v3.16.0', {"requires": ["get", "features"]});
...
}, 'patched-v3.16.0', {"requires": ["loader-base"]});
...
YUI.add('loader', function (Y, NAME) {}, 'patched-v3.16.0', {"use": ["loader-base", "loader-rollup", "loader-yui3"]});
